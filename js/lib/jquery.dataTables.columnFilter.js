...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input style="width:90%;" type="text" class="' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input type="text" style="width:35px;" class="number_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" style="width:35px;" class="number_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" style="width:85px;" class="date_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker({
        dateFormat : 'yy-mm-dd'
    });
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" style="width:85px;" class="date_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
